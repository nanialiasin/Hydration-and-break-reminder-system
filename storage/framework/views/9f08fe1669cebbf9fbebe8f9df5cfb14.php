...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/create-session.css'); ?>
</head>
<body>
    <div class="phone-shell">
        <div class="header">
            <a href="<?php echo e(route('home')); ?>" class="back-button" aria-label="Go back">
                <img src="<?php echo e(asset('images/arrow-left.svg')); ?>" alt="Back" width="24" height="24">
            </a>
            <h1>Create new session</h1>
        </div>

        <div class="content">
            <form class="session-form" method="POST" action="<?php echo e(route('session.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-actions">
                    <a href="<?php echo e(route('home')); ?>" class="btn btn-cancel">Cancel</a>
        ...
        <nav class="bottom-nav" aria-label="Main navigation">
            ...
            <a href="<?php echo e(route('session.create')); ?>" class="nav-item active" aria-label="Create">
...
<?php /**PATH C:\Users\Acer\Hydration-and-break-reminder-system\resources\views/create-session.blade.php ENDPATH**/ ?>