    ...
    <div class="app-shell">
        ...
        <div class="content">
            <div class="results-card">
                ...
                <form method="POST" action="<?php echo e(route('home')); ?>" class="session-actions">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\CHC PC\Herd\25s2-g15\resources\views/session-completed.blade.php ENDPATH**/ ?>